function setup(){
	createCanvas(491, 950);
	
}
var roomnumber = [{x: 435, y: 165}, {x1: 365, y1: 165}, {x2: 295, y2: 165}, {x3: 225, y3: 165}, {x4: 155, y4: 165}, {x5: 85, y5: 165}, {x6: 15, y6: 165}, {x7: 85, y7: 45}, {x8: 155, y8: 45}, {x9: 225, y9: 45}, {x10: 295, y10: 45}];
...
var rooms = [{x: 70, y: 0}, {x: 140, y: 0}, {x: 210, y: 0}, {x: 280,y: 0}, {x: 0, y: 120}, {x: 70, y: 120}, {x: 140, y: 120}, {x: 210, y: 120}, {x: 280, y: 120}, {x: 350, y: 120}, {x: 420, y: 120}];
...
var siderooms = [{x: 0, y: 95}, {x: 0, y: 70}];
...
function draw(){
	...
	fill(200, 200, 200);
	siderooms.forEach(function (point){
		var x = point.x;
		var y = point.y;
		rect(x, y, 40, 25);
	});
